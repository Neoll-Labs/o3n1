...
var (
	...
	ModuleBasics = module.NewBasicManager(
		...
		etherstatemodule.AppModuleBasic{},
...
type App struct {
	*baseapp.BaseApp
	...
	EtherstateKeeper etherstatemodulekeeper.Keeper
...
func New(
	...
	keys := sdk.NewKVStoreKeys(
		...
		etherstatemoduletypes.StoreKey,
	...
	*/
	...
	app.EtherstateKeeper = *etherstatemodulekeeper.NewKeeper(
		appCodec,
		keys[etherstatemoduletypes.StoreKey],
		keys[etherstatemoduletypes.MemStoreKey],
		app.GetSubspace(etherstatemoduletypes.ModuleName),
	)
	etherstateModule := etherstatemodule.NewAppModule(appCodec, app.EtherstateKeeper, app.AccountKeeper, app.BankKeeper)
	...
	app.mm.SetOrderBeginBlockers(
		...
		etherstatemoduletypes.ModuleName,
...
func initParamsKeeper(appCodec codec.BinaryCodec, legacyAmino *codec.LegacyAmino, key, tkey storetypes.StoreKey) paramskeeper.Keeper {
	...
	paramsKeeper.Subspace(etherstatemoduletypes.ModuleName)
