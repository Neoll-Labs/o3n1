...
func (*QueryParamsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_e67493acd2432778, []int{0}
}
...
func (*QueryParamsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_e67493acd2432778, []int{1}
}
...
func init() {
	proto.RegisterFile("storepositionether/storepositionether/query.proto", fileDescriptor_e67493acd2432778)
}
...
func (c *queryClient) Params(ctx context.Context, in *QueryParamsRequest, opts ...grpc.CallOption) (*QueryParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/storepositionether.storepositionether.Query/Params", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_Params_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/storepositionether.storepositionether.Query/Params",
	}
...
var _Query_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "storepositionether/storepositionether/query.proto",
}
